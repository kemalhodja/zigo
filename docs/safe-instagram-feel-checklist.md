...
1. `docs/safe-instagram-feel-checklist.md` (bu dosya)
2. `docs/visual-regression-checklist.md`
3. `docs/manual-qa-checklist.md`
4. `docs/final-acceptance-checklist.md`
