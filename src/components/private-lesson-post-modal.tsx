...
export function CreatePrivateLessonModal({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-start sm:justify-center overflow-y-auto bg-black/60 p-4 sm:p-6 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="relative w-full max-w-lg shrink-0 my-auto rounded-2xl bg-white p-5 shadow-2xl text-night">
