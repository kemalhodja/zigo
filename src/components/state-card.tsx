...
export async function StateCard({ title, description, action }: StateCardProps) {
  ...
  return (
    ...
    <div className="-mx-4 bg-white px-6 py-12 text-center">
      ...
      <p className="mx-auto mt-3 max-w-64 rounded-lg bg-slate-50 px-3 py-2 text-xs font-bold leading-5 text-slate-500">

        {m.state.defaultFooter}
