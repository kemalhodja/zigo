...
export const MemoryCard = memo(function MemoryCard({
  ...
  }, [isFlipped, isMatched, mouseX, mouseY]);
  ...
  return (
    <div className="relative aspect-square w-full perspective-[1000px]">
      <motion.button
        ...
        className={`relative w-full h-full rounded-2xl focus:outline-none tap-scale ${
          isMatched ? "cursor-default translate-z-[30px]" : "cursor-pointer"
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Holografik Parlama (Glare) Yalnızca kart kapalıyken */}
            {!isFlipped && !isMatched && (
              <motion.div
