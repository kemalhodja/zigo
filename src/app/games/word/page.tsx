...
export const metadata: Metadata = {
  title: "Kelime Avı · Zigo Oyun",
  description: "Türkçe ve İngilizce kelime bulmacalarıyla sözcük dağarcığını güçlendir.",
};
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-3 sm:p-6 flex flex-col items-center">
      <div className="w-full max-w-sm flex items-center justify-between mb-4">
        ...
        <span className="text-xs font-bold text-teal-500">Zigo Sözel Oyunu</span>
      </div>
