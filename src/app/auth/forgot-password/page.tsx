  ...
  return (
    <div className="space-y-5 pb-4">
      <section className="-mx-4 border-b border-violet-100 bg-white px-4 py-6">
        <h1 className="text-2xl font-black text-night">{a.forgotPasswordTitle}</h1>
        <p className="mt-2 text-sm font-bold leading-6 text-slate-500">{a.forgotPasswordLead}</p>
