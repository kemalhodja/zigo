...
async function StudentLearnContent({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* 1v1 Canlı Soru Düellosu Banner */}
      <section className="-mx-4 rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-500/15 via-orange-500/15 to-rose-500/15 p-4 mx-0 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <span className="flex size-11 items-center justify-center rounded-2xl bg-gradient-to-tr from-amber-500 to-orange-500 text-white shadow-md text-xl">
              ⚔️
            </span>
            <div>
              <div className="flex items-center gap-2">
                <h4 className="text-sm font-black text-slate-900">1v1 Canlı Soru Düellosu</h4>
                <span className="rounded-full bg-orange-500 px-2 py-0.5 text-[0.62rem] font-black uppercase tracking-wider text-white">
                  Canlı MEB
                </span>
              </div>
              <p className="text-xs font-semibold text-slate-600 mt-0.5">
                5 soruluk hızlı kapışmada bir öğrenciyle yarış, kazanan +25 Zigo Lig Puanı alsın!
              </p>
            </div>
          </div>
          <Link
            href="/duels"
            className="tap-scale inline-flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 px-4 py-2.5 text-xs font-black text-white shadow-md transition hover:brightness-105"
          >
            <span>🔥 Düelloya Katıl</span>
          </Link>
        </div>
      </section>
