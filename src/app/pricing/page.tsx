...
export default function PricingPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-8 text-center text-slate-100 bg-slate-950">
      <h1 className="text-3xl font-black text-crystal mb-4">Zigo Plus</h1>
      <p className="max-w-md text-slate-400 mb-8">
        Zigo'nun temel özellikleri tamamen ücretsizdir. Premium eğitim içerikleri ve ekstra 
        oyunlaştırma ödülleri için Zigo Plus'a geçin.
      </p>
      <div className="border border-slate-800 rounded-xl p-8 bg-slate-900 shadow-xl max-w-sm w-full">
