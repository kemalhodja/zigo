...
import { JigsawDrop } from "@/components/games/jigsaw-drop";
...
export const metadata: Metadata = {
  title: "Yapboz Düşüşü | Zigo Oyun",
  description: "Büyüyen tahtada parça yerleştir, satırları temizle, 2×2 patlat.",
};

export default async function JigsawDropPage() {
  const supabase = await createClient();
  const profile = await getCurrentProfile(supabase);

  if (!profile) {
    redirect("/auth?redirect=/student/games/jigsaw");
  }
