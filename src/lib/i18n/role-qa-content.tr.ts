  ...
  student: [
    {
      ...
      items: [
        ...
        { id: "student-feed", text: "Ana akış yalnızca seçili alanlardaki gönderi ve Spark'ları gösterir.", href: "/" },
        { id: "student-follow", text: "Akış, Micro veya Keşfet'ten doğrulanmış öğretmenleri takip et.", href: "/explore?format=teachers" },
    ...
    },
    {
      ...
      items: [
        { id: "student-micro", text: "Micro ders izle; puan yalnızca 60 saniyelik eşikten sonra alınabilsin.", href: "/micro" },
  ...
  parent: [
    {
      ...
      items: [
        ...
        { id: "parent-areas", text: "Aile kurulumundan çocuk Match-Feed alanlarını ata.", href: "/family" },
  ...
  teacher: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "teacher-reel", text: "/create?mode=micro ile Micro ders oluştur.", href: "/create?mode=micro" },
        { id: "teacher-story", text: "Atanan alanda /create?mode=spark ile Spark oluştur.", href: "/create?mode=spark" },
        { id: "teacher-answer", text: "Yalnızca atanan alanlardaki soruları cevapla.", href: "/questions" },
        { id: "teacher-profile", text: "Herkese açık profil ızgarası gönderi ve Micro dersleri göstersin.", href: "/profile" },
      ],
    },
  ],
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "admin-queue", text: "Moderasyon kuyrukları yorum, Spark yanıtı ve raporları ayırsın.", href: "/moderation" },
        { id: "admin-audit", text: "Onay/red eylemleri moderation_audit_log satırı oluştursun.", href: "/moderation" },
        { id: "admin-rate-limit", text: "Yorum ve Spark yanıtı spam denemeleri rate-limit geri bildirimi versin." },
      ],
    },
  ],
};
