...
const required = [
  ...
  [launchDoc.includes("migrationTarget: 118") || launchDoc.includes("migrationTarget: 117") || launchDoc.includes("migrationTarget: 91") || launchDoc.includes("migrationTarget: 66"), "final-launch doc references current health migration target"],
