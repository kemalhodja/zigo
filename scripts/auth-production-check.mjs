...
const required = [
  ...
  [reports.includes("checkRateLimitAsync(`report:") || reports.includes("checkRateLimit(`report:"), "reports route rate limited"],
  [questions.includes("checkRateLimitAsync(`question:") || questions.includes("checkRateLimit(`question:"), "questions route rate limited"],
