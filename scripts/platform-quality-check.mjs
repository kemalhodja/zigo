...
const required = [
  ...
  [platformDoc.includes("migrationTarget: 118") || platformDoc.includes("migrationTarget: 117") || platformDoc.includes("migrationTarget: 91") || platformDoc.includes("migrationTarget: 66") || platformDoc.includes("migrationTarget: 55") || platformDoc.includes("migrationTarget: 49"), "platform-quality doc references health migration target"],
