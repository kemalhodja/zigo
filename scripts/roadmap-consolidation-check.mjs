...
const required = [
  ...
  [roadmap.includes("091") || roadmap.includes("MIGRATION_TARGET = 91") || roadmap.includes("001–078") || roadmap.includes("001-078") || roadmap.includes("086") || roadmap.includes("MIGRATION_TARGET = 86") || roadmap.includes("001–066") || roadmap.includes("001-066") || roadmap.includes("MIGRATION_TARGET = 66"), "quality-roadmap must reference migrations 001-078+"],
