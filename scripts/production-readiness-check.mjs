...
const required = [
  ...
  [prodDoc.includes("migrationTarget: 86") || prodDoc.includes("migrationTarget: 66") || prodDoc.includes("migrationTarget: 55") || prodDoc.includes("migrationTarget: 49"), "production-readiness doc references migration target"],
  [prodChecklist.includes("086") || prodChecklist.includes("077") || prodChecklist.includes("066") || prodChecklist.includes("055") || prodChecklist.includes("049") || prodChecklist.includes("55"), "production-checklist references current migrations"],
